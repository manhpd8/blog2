	...
	<div id="body2">
		...
		<div id="bodyr">
			<div class="b_contentr">
				<div class="bmcell_r"><img src="/blog2/public/img/icon.png">{{$cate10[0]->cat_name}}</div>
				<div class="bmcell_r_sub">
					<div id="bmcell_r_img1"></div>
					<div class="bmcell_r_con">
						<p class="bmcell_r_con_tit">{{substr( $cate10[0]->news_name,  0, 51)}}</p>
						<p class="bmcell_r_con_p">{{substr( $cate10[0]->news_content,  0, 299)}}</p>
					</div>
					<a href="/blog2/public/news/newsid/{{$cate10[0]->news_id}}"><div class="btn_view">xem tiếp</div></a>
					
				</div>
			</div>

			<div class="b_contentr">
				<div class="bmcell_r"><img src="/blog2/public/img/icon.png">{{$cate1[0]->cat_name}}</div>
				@foreach($cate1 as $item1)
		            <div class="bmcell_r_sub">
					<div id="bmcell_r_img2" style="background-image: url('/blog2/public/img/{{$item1->news_img}}');"></div>
					<div class="bmcell_r_con">
						<p class="bmcell_r_con_tit">{{substr( $item1->news_name,  0, 51)}}</p>
						<p class="bmcell_r_con_p">{{substr( $item1->news_content,  0, 299)}}</p>
					</div>
					<a href="/blog2/public/news/newsid/{{$item1->news_id}}"><div class="btn_view">xem tiếp</div></a>
				</div>
				<hr >
		        @endforeach
				...
				<div id="br_foot">
					<div id="select_page">
						<img src="/blog2/public/img/back.png" id="btn_back">
						<button class="btn_page">1</button>
						<button class="btn_page">2</button>
						<button class="btn_page">3</button>
						<img src="/blog2/public/img/next.png" id="btn_next">
					</div>
				</div>
			</div>
